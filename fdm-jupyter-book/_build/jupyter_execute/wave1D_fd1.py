...
$$
\begin{equation}
0 = t_0 < t_1 < t_2 < \cdots < t_{N_t-1} < t_{N_t} = T \tp   \label{_auto2} \tag{7}
\end{equation}
$$
...
$$
\begin{equation}
0 = x_0 < x_1 < x_2 < \cdots < x_{N_x-1} < x_{N_x} = L \tp   \label{_auto3} \tag{8}
\end{equation}
$$
...
in a [web page](${doc_notes}/book/html/mov-wave/D_stencil_gpl/index.html)
or a [movie file](${docraw}/mov-wave/D_stencil_gpl/movie.ogg).
