...
def test_Gaussian(plot_u=1, version="scalar"):
    ...
    Ny = 40
    T = 15
    solver(I, f, c, bc, Lx, Ly, Nx, Ny, 0, T, user_action=action, version="scalar")
...
def test_const(plot=1, version="scalar"):
    ...
    Ny = 3
    T = 5
    solver(I, f, c, bc, Lx, Ly, Nx, Ny, 0, T, action, "scalar")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print(f"""Usage {sys.argv[0]} function arg1 arg2 arg3 ...""")
        sys.exit(0)
