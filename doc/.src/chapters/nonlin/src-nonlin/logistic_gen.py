...
print(iter_BE3)
print(f"Picard mean no of iterations (dt={dt:g}):", int(round(mean(iter_BE3))))
sys.exit(0)
...
print(f"Picard mean no of iterations (dt={dt:g}):", int(round(mean(iter_BE3))))
print(f"Newton mean no of iterations (dt={dt:g}):", int(round(mean(iter_BE4))))
