...
The solver functions presented in this section are implemented in
`src/vib/vib_undamped.py`. The source file includes a built-in test
function `test_three_steps()` that verifies correctness.
:::
...
[`vib_undamped_odespy.py`](https://github.com/devitocodes/devito_book/tree/main/src/vib/vib_undamped_odespy.py)
...
The function below, found in [`vib_undamped_EulerCromer.py`](https://github.com/devitocodes/devito_book/tree/main/src/vib/vib_undamped_EulerCromer.py), implements the Euler-Cromer scheme
(@eq-vib-model2x2-EulerCromer-veq1b)-(@eq-vib-model2x2-EulerCromer-ueq1b):
...
[`vib_undamped_staggered.py`](https://github.com/devitocodes/devito_book/tree/main/src/vib/vib_undamped_staggered.py)
