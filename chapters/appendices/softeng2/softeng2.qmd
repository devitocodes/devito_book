...
### Storing individual arrays {#sec-softeng2-wave1D-filestorage-savez}
...
## Using `joblib` to store arrays in files {#sec-softeng2-wave1D-filestorage-joblib}
...
## Using a hash to create a file or directory name {#sec-softeng2-wave1D-filestorage-hash}

Array storage techniques like those outlined in Sections
@sec-softeng2-wave1D-filestorage-joblib and
@sec-softeng2-wave1D-filestorage-savez demand the user to assign a
...
## Making hash strings from input data {#sec-softeng2-wave1D-filestorage-hashlib}
...
## Avoiding rerunning previously run cases {#sec-softeng2-wave1D-filestorage-norerun}
...
Section @sec-softeng2-wave1D-filestorage provides a recipe for
