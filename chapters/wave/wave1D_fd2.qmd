...
![Modified stencil at a boundary with a Neumann condition. The ghost point $u_{-1}^n$ is eliminated using $u_{-1}^n = u_1^n$.](fig/stencil_n_left){#fig-wave-pde1-fig-Neumann-stencil width="500px"}
