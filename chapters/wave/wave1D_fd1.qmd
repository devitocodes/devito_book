...
![Mesh in space and time. Filled circles represent known values from previous time steps; the empty circle is the unknown to be computed.](fig/stencil_n_interior){#fig-wave-pde1-fig-mesh width="500px"}
...
![Modified stencil for the first time step. Only values at $n=0$ (initial condition) are needed since there is no $n-1$ level yet.](fig/stencil_n0_interior){#fig-wave-pde1-fig-stencil-u1 width="500px"}
