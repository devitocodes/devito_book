...
@eq-wave-pde1-analysis for details). Both the primary physical
...
in a [web page](http://hplgit.github.io/fdm-book/doc/pub/book/html/mov-wave/D_stencil_gpl/index.html)
or a "movie file":
"{{< var docraw >}}/mov-wave/D_stencil_gpl/movie.ogg".


## Sketch of an implementation
{#sec-wave-string-impl}
...
{#sec-wave-pde2-fd-standing-waves}
...
of 2 (see Section @eq-wave-pde1-analysis), so if the computed rates
...
\\
E &= ||e^n_i||**{\ell^\infty} = \max**{i,n} |e^n_i|\tp
...
{#sec-wave-pde2-fd-verify-quadratic}
...
(although we in Section @eq-wave-pde1-analysis establish such knowledge
in simple cases).
