## Analysis of the wave equation {#sec-wave-pde1-analysis}

### Properties of the solution {#sec-wave-pde1-properties}
...
## More precise definition of Fourier representations {#sec-wave-pde1-Fourier}
...
$$ {#eq-wave-pde1-Fourier-I}
$$
A(k) = \int_{-\infty}^\infty I(x)e^{-ikx}dx\tp
$$ {#eq-wave-pde1-Fourier-A}
...
## Stability {#sec-wave-pde1-stability}
...
## Numerical dispersion relation {#sec-wave-pde1-num-dispersion}
...
## Extending the analysis to 2D and 3D {#sec-wave-pde1-analysis-2D3D}
...
```{.python include="../src/wave/analysis/dispersion_relation_2D.py" start-after="def disp" end-before="# See"}
```

![Error in numerical dispersion in 2D.](fig/disprel2D.png){#fig-wave-pde1-fig-disprel2D width="600px"}
