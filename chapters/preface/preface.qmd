...
:::{.callout-note title="*Some people think that stiff challenges are the best device to"}
...
demonstrate, especially in Appendix @eq-ch-softeng2, how to port
...
of this book (Chapters @eq-ch-vib, @eq-ch-wave, and Appendix
@eq-ch-softeng2) is devoted to wave phenomena. Extended material on
