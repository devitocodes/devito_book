...
{#sec-diffu-randomwalk}

Models leading to diffusion equations, see Section @eq-diffu-app, are
...
depicted in Figure @eq-diffu-randomwalk-1D-code1-fig1. The particle starts
...
see Section @eq-diffu-randomwalk-1D-EVar) and also provide data from
...
Section @eq-diffu-randomwalk-1D-EVar points to recording
...
as we found in Section @eq-diffu-randomwalk-1D-EVar.
...
@eq-diffu-randomwalk-1D-code1, but each step is now a vector in $d$
