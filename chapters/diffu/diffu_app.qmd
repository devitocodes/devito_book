...
@sec-diffu-app-substance-fig1.  We realize that only the normal
...
The relation (@sec-diffu-app-substance-Fick) is known as Fick's law.
Inserting (@sec-diffu-app-substance-Fick) in
(@sec-diffu-app-substance-massconv) gives a scalar PDE for the
concentration $c$:
...
Figure @sec-diffu-app-substance-fig1, the corresponding increase in internal
