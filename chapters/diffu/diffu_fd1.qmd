...
see @sec-diffu-devito for the Devito-based implementation. The tested solver
is available in `src/diffu/diffu1D_devito.py` with tests in `tests/test_diffu_devito.py`.
:::
