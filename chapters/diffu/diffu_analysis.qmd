---
title: "Diffu Analysis.Do"
---

{#sec-diffu-pde1-analysis}

The numerical experiments in Sections
@eq-diffu-pde1-FE-experiments and @eq-diffu-pde1-theta-experiments
...
Figures @fig-diffu-pde1-FE-fig-F=0.5-@fig-diffu-pde1-CN-fig-F=10.

## Properties of the solution
{#sec-diffu-pde1-analysis-uex}
...
{#sec-diffu-pde1-analysis-details}
...
explained in ref[Appendix @eq-ch-trunc][ in
...
ref[Appendix @eq-trunc-diffu-1D][ in
...
{#sec-diffu-pde1-analysis-leapfrog}
...
Details are provided in Section @eq-advec-1D-leapfrog.
...
@fig-diffu-pde1-fig-A-err-C20, @fig-diffu-pde1-fig-A-err-C0.5, and
@fig-diffu-pde1-fig-A-err-C0.1 show how long and small waves are
...
![Amplification factors for time steps around the Forward Euler stability limit.](fig/diffusion_A_F05_F025){#fig-diffu-pde1-fig-A-err-C0.5 width="800px"}

![Amplification factors for small time steps.](fig/diffusion_A_F01_F001){#fig-diffu-pde1-fig-A-err-C0.1 width="800px"}
...
Section @eq-diffu-pde1-FE-experiments. Can we, from the analysis
above, explain the behavior?

We may start by looking at Figure @fig-diffu-pde1-FE-fig-F=0.51
...
Figure @fig-diffu-pde1-FE-fig-F=0.5 has unexpected features:
we would expect the solution of the diffusion equation to be
smooth, but the graphs in Figure @fig-diffu-pde1-FE-fig-F=0.5
contain non-smooth noise. Turning to Figure
@fig-diffu-pde1-FE-fig-gauss-F=0.5,  which has a quite similar
initial condition, we see that the curves are indeed smooth.
The problem with the results in Figure @fig-diffu-pde1-FE-fig-F=0.5
...
smooth initial condition in Figure @fig-diffu-pde1-FE-fig-gauss-F=0.5,
...
smooth solutions in Figure @fig-diffu-pde1-FE-fig-F=0.25, where
$F=\frac{1}{4}$.

Turning the attention to the Backward Euler scheme and the experiments
in Figure @fig-diffu-pde1-BE-fig-F=0.5, we see that even the discontinuous
...
{#sec-diffu-exer-1D-gaussian-symmetric}
