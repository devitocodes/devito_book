...
## The Lax-Wendroff method {#sec-advec-1D-LaxW}
...
## Analysis of dispersion relations {#sec-advec-1D-disprel}
...
$$
Figures
@fig-advec-1D-disprel-C1-1--@fig-advec-1D-disprel-C05-2 contain
...
## Stationary 1D advection-diffusion {#sec-advec-1D-stationary}
...
## A simple model problem {#sec-advec-1D-stationary-model}
...
## A centered finite difference scheme {#sec-advec-1D-stationary-fdm}
...
Figure @fig-advec-1D-stationary-fdm-fig1 shows reasonably accurate
...
solutions as depicted in Figure @fig-advec-1D-stationary-fdm-fig2.
...
## Remedy: upwind finite difference scheme {#sec-advec-1D-stationary-upwind}
...
in Section @sec-advec-1D-stationary-fdm. The results appear in Figures
...
## Applications of advection equations {#sec-advec-app}
...
diffusion models in Section @sec-diffu-app,
...
$$
## Transport of a substance {#sec-advec-app-mass}
...
$$
## Transport of heat in fluids {#sec-advec-app-heat}
