...
Use [`logistic.py`](https://github.com/devitocodes/devito_book/tree/main/src/nonlin/logistic.py) to compare the case
...
The program [`Newton_demo.py`](https://github.com/devitocodes/devito_book/tree/main/src/nonlin/Newton_demo.py) illustrates
