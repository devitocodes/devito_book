...
The program [`logistic.py`](https://github.com/hplgit/fdm-book/tree/master/src/nonlin/logistic.py) contains
...
(Experiments can be done with the code [`ODE_Picard_tricks.py`](https://github.com/hplgit/fdm-book/tree/master/src/nonlin/ODE_Picard_tricks.py).)
:::
