---
title: "Nonlin Split.Do"
---

{#sec-nonlin-splitting}
...
## Strange splitting for ODEs
{#sec-nonlin-splitting-ODE-Strange}

The accuracy of the splitting method in Section @eq-nonlin-splitting-ODE
...
### Results
Figure @eq-nonlin-splitting-ODE-logistic-fig shows that the impact of
...
@eq-nonlin-splitting-ODE-logistic-fig), the asymptotic values are off
by 20-30%.  A more reasonable time step ($\Delta t = 0.05$, right plot
in Figure @eq-nonlin-splitting-ODE-logistic-fig) gives better
...
by applying an explicit scheme for (@eq-nonlin-splitting-RD-eq-decay)
...
{#sec-nonlin-splitting-RD-linearR}
...
We refer to ref[Section @eq-diffu-pde1-analysis][ in
